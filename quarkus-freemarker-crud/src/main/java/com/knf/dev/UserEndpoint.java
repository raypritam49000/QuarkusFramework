...
public class UserEndpoint {
    ...
    @Path("/create")
    @Produces(MediaType.TEXT_HTML)
    public String createUserView() throws TemplateException, IOException {
        User user = new User();
    ...
    @Path("/create")
    public String createUser(@FormParam("firstName") String firstName, @FormParam("lastName") String lastName,
                             @FormParam("email") String email) throws TemplateException, IOException {
        User usr = new User();
        usr.setEmail(email);
